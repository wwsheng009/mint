...
type VirtualListVNode struct {
	*ElementVNode
	...
	renderItem     func(interface{}) VNode // Function to render each item
...
func NewVirtualList() *VirtualListVNode {
	return &VirtualListVNode{
		ElementVNode:   NewElement("virtuallist"),
...
func VirtualList(items []interface{}, renderItem func(interface{}) VNode) VNode {
	return &VirtualListVNode{
		ElementVNode: NewElement("virtuallist"),
		items:        items,
		itemCount:    len(items),
...
func (b *VirtualListBuilderType) RenderItem(fn func(interface{}) VNode) *VirtualListBuilderType {
...
// Build returns the virtual list VNode
func (b *VirtualListBuilderType) Build() VNode {
	return b.node
}
...
func (v *VirtualListVNode) RenderItem() func(interface{}) VNode { return v.renderItem }
...
func (v *VirtualListVNode) SetRenderItem(fn func(interface{}) VNode) { v.renderItem = fn }
