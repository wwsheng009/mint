...
// OnFocus returns the focus handler
...
// OnBlur returns the blur handler
...
// OnSubmit returns the submit handler (Enter key)
...
func NewTextarea() *TextareaVNode {
	return &TextareaVNode{
		ElementVNode: NewElement("textarea"),
		value:        "",
		placeholder:  "",
		rows:         3,
		cols:         40,
...
// OnSubmit returns the submit handler
...
// Build returns the VNode
func (b *TextareaBuilderType) Build() VNode {
	return b.node
}
