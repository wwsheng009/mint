...
- 71 top-level component packages live in `../../ui/components` excluding `docs` and `internal`.
...
| Transfer | `../../ui/components/transfer/README.md` | Transfer list with search, paging and visible-item bulk operations. |
