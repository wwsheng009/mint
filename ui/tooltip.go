...
func NewTooltip() *TooltipVNode {
	return &TooltipVNode{
		ElementVNode: NewElement("tooltip"),
		content:      nil,
		text:         "",
...
func Tooltip(content VNode, text string) VNode {
	return &TooltipVNode{
		ElementVNode: NewElement("tooltip"),
		content:      content,
		text:         text,
...
func TooltipBuilder(content VNode) *TooltipBuilderType {
...
// Build returns the tooltip VNode
func (b *TooltipBuilderType) Build() VNode {
	return b.node
}

// Getters
func (t *TooltipVNode) Content() VNode        { return t.content }
...
func Toast(message string) VNode {
	return &ToastVNode{
		ElementVNode: NewElement("toast"),
		title:        "",
		message:      message,
...
// Build returns the toast VNode
func (b *ToastBuilderType) Build() VNode {
	return b.node
}
...
func (tm *ToastManager) Show(toast VNode) {
...
func (tm *ToastManager) Remove(toast VNode) {
...
func (tm *ToastManager) GetToasts() []VNode {
	return tm.toasts
}
