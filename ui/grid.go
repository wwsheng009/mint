...
type GridVNode struct {
	*ElementVNode
	...
	alignContent Align  // Alignment of the whole grid in the container
}

// NewGrid creates a new grid
func NewGrid() *GridVNode {
	return &GridVNode{
		ElementVNode:  NewElement("grid"),
...
func Grid(columns, rows []GridDimension, cells ...VNode) VNode {
	grid := NewGrid()
...
func (b *GridBuilderType) Cell(row, col int, child VNode) *GridBuilderType {
...
func (b *GridBuilderType) CellSpan(row, col, rowSpan, colSpan int, child VNode) *GridBuilderType {
	b.cellDefs = append(b.cellDefs, GridCell{
		Child:   child,
		Row:     row,
		Col:     col,
...
func (b *GridBuilderType) AlignContent(a Align) *GridBuilderType {
...
func (b *GridBuilderType) Build() VNode {
...
func (g *GridVNode) AlignContent() Align     { return g.alignContent }
...
func (g *GridVNode) SetAlignContent(a Align) { g.alignContent = a }
