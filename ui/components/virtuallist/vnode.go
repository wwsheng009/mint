...
func (v *VNode) Props() rtui.Props {
	...
	if v.itemStyleFn != nil {
		props[propItemStyleFn] = v.itemStyleFn
	}
	return props
}
...
func (v *VNode) SetProps(p rtui.Props) rtui.VNode {
	...
	if fn, ok := p[propItemStyleFn].(func(int, string) style.Style); ok {
		v.itemStyleFn = fn
	} else if _, exists := p[propItemStyleFn]; exists {
		v.itemStyleFn = nil
	}
	return v
}
...
func (v *VNode) SetItemStyleFn(fn func(int, string) style.Style) *VNode {
	v.itemStyleFn = fn
	return v
}
...
func (v *VNode) ItemStyleFn() func(int, string) style.Style { return v.itemStyleFn }
