...
// VNode is the declarative description of a TimePicker component.
type VNode struct {
	*rtui.ElementVNode
...
// New creates a new TimePicker VNode.
func New() *VNode {
	return &VNode{
		ElementVNode: rtui.NewElement("timepicker"),
...
func (v *VNode) Tag() string { return "timepicker" }
