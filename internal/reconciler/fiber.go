...
type Fiber struct {
	...
	ComponentInstance ui.ComponentInstance
}
...
func CreateFiber(vnode ui.VNode) *Fiber {
	if vnode == nil {
		return nil
	}
...
func CreateFiberFromVNode(vnode ui.VNode) *Fiber {
...
func buildFiberTree(parentFiber *Fiber, parentVNode ui.VNode) {
